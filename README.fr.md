...
```
php bin/selftest.php      1 183 contrôles   logique de détection, hors ligne, sans réseau
...
php bin/e2e.php           301 contrôles   parcours complet en HTTP réel, instance isolée
...
**2 058 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
