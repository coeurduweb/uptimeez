...
```
php bin/selftest.php      844 contrôles   logique de détection, hors ligne, sans réseau
...
**1 539 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
