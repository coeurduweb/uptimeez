...
```
php bin/selftest.php      1 025 contrôles   logique de détection, hors ligne, sans réseau
...
**1 721 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
