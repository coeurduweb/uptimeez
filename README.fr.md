...
```
php bin/selftest.php      839 contrôles   logique de détection, hors ligne, sans réseau
...
**1 534 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
