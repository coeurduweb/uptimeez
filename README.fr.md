...
```
php bin/selftest.php      1 062 contrôles   logique de détection, hors ligne, sans réseau
php bin/bench.php          73 contrôles   vraies pannes reproduites de bout en bout (dont badssl.com)
php bin/e2e.php           265 contrôles   parcours complet en HTTP réel, instance isolée
...
**1 770 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
