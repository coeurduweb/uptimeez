...
```
php bin/selftest.php      1 043 contrôles   logique de détection, hors ligne, sans réseau
...
**1 739 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
