...
```
php bin/selftest.php      914 contrôles   logique de détection, hors ligne, sans réseau
...
**1 610 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
