...
```
php bin/selftest.php      1 139 contrôles   logique de détection, hors ligne, sans réseau
...
**1 873 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
