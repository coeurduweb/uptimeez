...
```
php bin/selftest.php      1 192 contrôles   logique de détection, hors ligne, sans réseau
...
**2 070 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
