...
```
php bin/selftest.php      1 006 contrôles   logique de détection, hors ligne, sans réseau
...
**1 702 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
