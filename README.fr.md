...
```
php bin/selftest.php      952 contrôles   logique de détection, hors ligne, sans réseau
...
**1 648 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
