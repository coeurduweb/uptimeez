...
```
php bin/selftest.php      924 contrôles   logique de détection, hors ligne, sans réseau
...
**1 620 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
