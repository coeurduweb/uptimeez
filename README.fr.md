...
```
php bin/selftest.php      960 contrôles   logique de détection, hors ligne, sans réseau
...
**1 656 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
