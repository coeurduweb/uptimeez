...
```
php bin/selftest.php      855 contrôles   logique de détection, hors ligne, sans réseau
...
**1 550 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
