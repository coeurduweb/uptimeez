...
```
php bin/selftest.php      909 contrôles   logique de détection, hors ligne, sans réseau
...
**1 605 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
