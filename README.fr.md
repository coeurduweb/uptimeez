...
```
php bin/selftest.php      875 contrôles   logique de détection, hors ligne, sans réseau
...
**1 570 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
