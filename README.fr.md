...
```
php bin/selftest.php      870 contrôles   logique de détection, hors ligne, sans réseau
...
**1 565 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
