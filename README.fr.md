...
```
php bin/selftest.php      884 contrôles   logique de détection, hors ligne, sans réseau
...
**1 579 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
