...
```
php bin/selftest.php      1 231 contrôles   logique de détection, hors ligne, sans réseau
...
**2 151 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
