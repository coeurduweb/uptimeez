...
```
php bin/selftest.php      900 contrôles   logique de détection, hors ligne, sans réseau
...
**1 595 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
