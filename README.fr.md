...
```
php bin/selftest.php      944 contrôles   logique de détection, hors ligne, sans réseau
...
**1 640 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
