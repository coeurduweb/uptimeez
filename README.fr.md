...
```
php bin/selftest.php      1 220 contrôles   logique de détection, hors ligne, sans réseau
...
php bin/e2e.php           319 contrôles   parcours complet en HTTP réel, instance isolée
...
**2 137 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
