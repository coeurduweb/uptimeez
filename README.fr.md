...
```
php bin/selftest.php      1 151 contrôles   logique de détection, hors ligne, sans réseau
...
**1 998 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
