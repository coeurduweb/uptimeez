...
```
php bin/selftest.php      867 contrôles   logique de détection, hors ligne, sans réseau
...
**1 562 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
