...
```
php bin/selftest.php      991 contrôles   logique de détection, hors ligne, sans réseau
...
**1 687 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
