...
```
php bin/selftest.php      879 contrôles   logique de détection, hors ligne, sans réseau
...
**1 574 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
