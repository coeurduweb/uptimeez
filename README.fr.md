...
```
php bin/selftest.php      978 contrôles   logique de détection, hors ligne, sans réseau
...
**1 674 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
