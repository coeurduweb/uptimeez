...
```
php bin/selftest.php      878 contrôles   logique de détection, hors ligne, sans réseau
...
**1 573 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
