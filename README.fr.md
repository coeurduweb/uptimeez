...
```
php bin/selftest.php      829 contrôles   logique de détection, hors ligne, sans réseau
...
**1 524 contrôles, tous verts**, plus zéro code mort et un catalogue par défaut complet.
