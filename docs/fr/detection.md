...
Cette page explique ce qu'Uptimer regarde réellement. C'est important pour deux raisons : il faut faire confiance à
...
Une page qui répond `200` peut être inutilisable. Uptimer récupère le HTML, extrait chaque feuille de style, script
...
page d'accueil entièrement mise en cache. Uptimer ajoute cette sonde automatiquement quand il détecte WordPress.
...
## Ce qu'Uptimer ne fait volontairement pas
