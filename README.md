...
```
php bin/selftest.php      1,181 checks   detection logic, offline, no network needed
...
php bin/e2e.php           301 checks   full user journey over real HTTP, isolated instance
...
**2,056 checks, all green**, plus zero dead code and a complete default catalogue.
