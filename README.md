...
```
php bin/selftest.php      1,092 checks   detection logic, offline, no network needed
...
**1,800 checks, all green**, plus zero dead code and a complete default catalogue.
