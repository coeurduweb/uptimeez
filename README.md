...
```
php bin/selftest.php      1,173 checks   detection logic, offline, no network needed
...
**2,038 checks, all green**, plus zero dead code and a complete default catalogue.
