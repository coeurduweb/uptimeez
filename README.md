...
php bin/e2e.php           276 checks   full user journey over real HTTP, isolated instance
...
**1,840 checks, all green**, plus zero dead code and a complete default catalogue.
