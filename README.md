...
php bin/e2e.php           275 checks   full user journey over real HTTP, isolated instance
...
**1,810 checks, all green**, plus zero dead code and a complete default catalogue.
