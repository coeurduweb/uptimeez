...
```
php bin/selftest.php      1,197 checks   detection logic, offline, no network needed
...
**2,075 checks, all green**, plus zero dead code and a complete default catalogue.
