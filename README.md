...
```
php bin/selftest.php      1,006 checks   detection logic, offline, no network needed
...
**1,702 checks, all green**, plus zero dead code and a complete default catalogue.
