...
```
php bin/selftest.php      1,192 checks   detection logic, offline, no network needed
php bin/regles.php        130 checks   one file per rule, each runnable alone in 0.04 s
php bin/bench.php          74 checks   real failures reproduced end to end (incl. badssl.com)
php bin/e2e.php           304 checks   full user journey over real HTTP, isolated instance
...
**2,070 checks, all green**, plus zero dead code and a complete default catalogue.
