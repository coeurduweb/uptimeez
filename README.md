...
```
php bin/selftest.php      1,139 checks   detection logic, offline, no network needed
...
**1,873 checks, all green**, plus zero dead code and a complete default catalogue.
