...
```
php bin/selftest.php      1,025 checks   detection logic, offline, no network needed
...
**1,721 checks, all green**, plus zero dead code and a complete default catalogue.
