...
```
php bin/selftest.php      1,062 checks   detection logic, offline, no network needed
php bin/bench.php          73 checks   real failures reproduced end to end (incl. badssl.com)
php bin/e2e.php           265 checks   full user journey over real HTTP, isolated instance
...
**1,770 checks, all green**, plus zero dead code and a complete default catalogue.
