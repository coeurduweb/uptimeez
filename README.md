...
```
php bin/selftest.php      1,183 checks   detection logic, offline, no network needed
...
**2,058 checks, all green**, plus zero dead code and a complete default catalogue.
