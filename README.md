...
```
php bin/selftest.php      1,008 checks   detection logic, offline, no network needed
...
**1,704 checks, all green**, plus zero dead code and a complete default catalogue.
