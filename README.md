...
```
php bin/selftest.php      1,136 checks   detection logic, offline, no network needed
...
**1,870 checks, all green**, plus zero dead code and a complete default catalogue.
